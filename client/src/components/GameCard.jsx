...
export default function GameCard({ game, index }) {
  return (
    <motion.div
      ...
      className="group relative aspect-square rounded-xl sm:rounded-2xl overflow-hidden cursor-pointer shadow-xl border-2 border-primary bg-background-dark"
    >
      <Link to={game.link} className="block w-full h-full">
        ...
        {/* Content */}
        <div className="absolute inset-0 p-2 sm:p-5 flex flex-col justify-end">
            ...
            <h3 className="text-[10px] leading-tight sm:text-xl md:text-2xl font-bold text-white mb-1 sm:transform sm:translate-y-2 sm:group-hover:translate-y-0 transition-transform duration-300 font-heading">
                {game.title}
            </h3>

            <div className="hidden sm:flex items-center gap-2 text-primary opacity-0 transform translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
